...
$config['db_name'] = 'favishop';
$config['db_user'] = 'root';
$config['db_password'] = '';

/* HELIOHOST
$config['db_host'] = 'johnny.heliohost.org';
$config['db_name'] = 'amemaria_favishop';
$config['db_user'] = 'amemaria_rporter';
$config['db_password'] = 'JD^cOLmN~zsr';
*/
...
$config['http_path'] = '/favishop';

// Host and directory where software is installed on secure server
$config['https_host'] = 'localhost';
$config['https_path'] = '/favishop';
