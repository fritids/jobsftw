<?php /* Smarty version Smarty-3.1.13, created on 2013-08-31 11:03:42
         compiled from "C:\Dropbox\www\favishop\design\themes\basic\templates\blocks\my_account.tpl" */ ?>
<?php /*%%SmartyHeaderCode:294435221954ee5f826-20719123%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'abd5adca8ba098ae2de8a2a51483513c08a8e5a9' => 
    array (
      0 => 'C:\\Dropbox\\www\\favishop\\design\\themes\\basic\\templates\\blocks\\my_account.tpl',
      1 => 1377579246,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '294435221954ee5f826-20719123',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5221954f28c6e7_19466869',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5221954f28c6e7_19466869')) {function content_5221954f28c6e7_19466869($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include 'C:/Dropbox/www/favishop/app/functions/smarty_plugins\\block.hook.php';
if (!is_callable('smarty_function_set_id')) include 'C:/Dropbox/www/favishop/app/functions/smarty_plugins\\function.set_id.php';
?><?php
fn_preload_lang_vars(array('profile_details','downloads','orders','view_compare_list','apply_for_vendor_account','track_my_order','track_my_order','order_id','email','go','sign_in','profile_details','downloads','orders','view_compare_list','apply_for_vendor_account','track_my_order','track_my_order','order_id','email','go','sign_in'));
?>
...
" rel="nofollow" class="underlined">MY ACCOUNT</a>     |     <a href="<?php echo htmlspecialchars(fn_url("auth.logout?redirect_url=".((string)$_smarty_tpl->tpl_vars['return_current_url']->value)), ENT_QUOTES, 'UTF-8');?>
" rel="nofollow" class="account">SIGN OUT</a>
        <?php }else{ ?>
...
" class="cm-dialog-opener cm-dialog-auto-size account"<?php }else{ ?>rel="nofollow" class="account"<?php }?>>LOGIN</a>     |     <a href="<?php echo htmlspecialchars(fn_url("profiles.add"), ENT_QUOTES, 'UTF-8');?>
" rel="nofollow" class="account">SIGNUP</a>
